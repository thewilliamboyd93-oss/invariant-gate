"""
Labeled scenario set for the invariant-gate comparative claim.

Each scenario is a real ToolContract (using the actual invariant_gate
...
(you) who built invariant-gate. That's the same self-authored-evidence
...
TMP_DIR = tempfile.mkdtemp(prefix="invariant_gate_comparative_")
